...
async def step1_execute_login(
    ...
    try:
        ...
        validation = await _validate_account_info(context, logger)
        ...
        microsoft_tokens = await _get_microsoft_token(context, logger)
        ...
        xbox_tokens = await _get_xbox_live_token(microsoft_tokens, context, logger)
